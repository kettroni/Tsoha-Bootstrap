...
INSERT INTO Task (name, description, added, tasklist_id) VALUES ('Ensimmäinen asia', 'Tässä on tietoa ensimmäisestä asiasta',
   NOW(), 1);
...
INSERT INTO Task (name, description, added, tasklist_id) VALUES ('Asia1', 'Asia numero 1'
  , NOW(), 2);
